	...
	<div class="container items">
		<div class="row">			
			...
			<div class="col-sm-6 col-xs-12 no-p">
				<a href="<?php the_permalink(); ?>" data-href="#project-<?php the_ID(); ?>" class="<?php echo $class; ?>" style="background-image: url(<?php if(has_post_thumbnail()) echo get_the_post_thumbnail_url( get_the_ID(), 'image-540-auto' ); ?>)">
					<div class="vertical-middle">
						<?php $log = get_field('logo'); 
						if($log) :
						?>
						<object type="image/svg+xml" data="<?php echo $log['url']; ?>" class="logo"></object>
						<?php endif; ?>
					</div>
				</a>
			</div>
